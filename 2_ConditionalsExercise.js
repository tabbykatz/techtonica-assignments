...
//let testVar = true;
//let testVar2 = false;
//this one is confusing? I could also remove one equals for softer comparison. Or, taking your question more
//literally, I could write typeof() checks to make sure varA & B are strings or numbers first. I will bring this one up at the study group.
//exercise4(testVar, testVar2);
...
// consider other data types beside strings and variables. <--- do you mean numbers?

//I wrote the above comment before proceeding to this one. Depending upon how one wrote the function, the number 1 could be equal to "one"
// but not mine. I wrote mine with strict comparison because the value or "one" does not usually equal the number or integer 1, that's a Js
//thing.

// testing to make sure varA and varB are of the same datatype seems heavy handed when we have strict comparison, the comparison will fail and the else will kick in.
// But if you meant for us to only
// return equal if they are numbers or strings *and* have the same value,
//then I should have checked typeof(), because Booleans are not numbers or strings.

//this function cannot work for lists, etc, as it is not designed to move through the lists. It does, however, work for Booleans.
//
...
function exercise8(amount1, amount2, minimum, maximum) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
  if (amount1 < maximum && amount2 < maximum && amount1 > minimum && amount2 > minimum) {
    answer8 = true;
  } else {
    answer8 = false;
  }
...
// This was fun and easy. I obviously deliberated a bit about how to read your question for #4 and my comments there are all over the place.
// I used w3schools briefly to check the switch syntax.
