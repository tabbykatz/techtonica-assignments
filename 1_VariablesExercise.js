...
let dreamDestination = "some tiny pub in Ireland where Alasdair Roberts is singing";
...
// the difference is in exclusive vs. inclusive of the number range given
//num1 could be 1 - 10 exclusive (of 1 and 10) / 2 - 9 inclusive
//num2 could be 1 - 10 inclusive
// so num2 includes 1 & 10 while num1 does not
...
//I've assumed you mean our variable theProduct
...
// This was easy and fun. The one exercise I'm curious about is 22. Is it true because the righthand statement is evaluated?
// The only reference I used was console.log()
